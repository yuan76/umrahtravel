...
// } else {
    ...
    if($check !== false) {
		...
		if($fileSize > 0 || $fileError == 0){
			...
			$sql = "insert into orderlink (nama_dpn,nama_blk,kodeNeg,nomor,username,gambar,tipe,referal)
							values ('$kecilDpn','$kecilBlk','$neg','$no','$userBaru','gambar/$fileName','$tipe','$ref')";
